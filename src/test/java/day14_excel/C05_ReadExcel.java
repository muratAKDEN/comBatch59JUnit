...
public class C05_ReadExcel {
    ...
    public void readExcelTest() throws IOException {
        ...
        // sayfa 2ye gidip son satir sayisinin 24 ,
        // kullanilan satir sayisinin ise 12 old test edin
        ...
        int expectedNumberOfRowsUsed=12;
        Assert.assertEquals(expectedNumberOfRowsUsed,kullanilanSatirSayisi);
